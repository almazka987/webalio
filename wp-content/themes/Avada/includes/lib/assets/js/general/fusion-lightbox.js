...
window.avadaLightBox.activate_lightbox = function( $wrapper ) {
	...
	if ( Boolean( Number( fusionLightboxVars.lightbox_post_images ) ) ) {
...
window.avadaLightBox.prepare_options = function( $linkID, $gallery ) {
	...
	if ( 'undefined' === typeof $gallery ) {
		$gallery = Boolean( Number( fusionLightboxVars.lightbox_gallery  ) );
	}
	...
	$ilightboxArgs = {
		...
		show: {
			...
			speed: $showSpeed[fusionLightboxVars.lightbox_animation_speed]
		},
		...
		slideshow: {
			...
			pauseOnHover: false,
			startPaused: $autoplay[Number( fusionLightboxVars.lightbox_autoplay )]
		},
		overlay: {
	...
	// For social sharing
	if ( Boolean( Number( fusionLightboxVars.lightbox_social ) ) ) {
	...
	// For deep linking
	if ( Boolean( Number( fusionLightboxVars.lightbox_deeplinking ) ) ) {
