...
/*
*************************************** 
Displaying for all posts / if layout is grid
***************************************
*/ 
				...
				<div class="gallery-owl owl-carousel">
					<?php foreach( $images as $image ) : ?>
						...
						<a href="<?php echo esc_url( $image['url'] ); ?>">
							<img src="<?php echo esc_url( $image['sizes']['hannah_cd_grid'] ); ?>" alt="<?php echo esc_attr( $image['alt'] ); ?>" />
    ...
    <?php if( ! ACF_GF('social_blogbar_show', 'option') || ! ACF_GF('post_meta_show_archive', 'option') ) { ?>
        <div class="grid-info">
    <?php }
    ...
    if( ! ACF_GF('social_blogbar_show', 'option') || ! ACF_GF('post_meta_show_archive', 'option') ) { ?>
        </div>
    <?php } ?> 
