...
if( ! empty( $hannah_cd_visibility ) ) {
    foreach( $hannah_cd_visibility as $display ) :
        if( $hannah_cd_visibility_cases[ $display ] ) : ?>
            ...
            <div class="ending-area<?php if( $area_grid ) { ?> content-grid<?php } ?>">                
                <div class="container">
                    <div class="row">
                        ...
                        // POST TYPE CAROUSEL (POSTS, PRODUCTS)  
                            ...
                            <div class="area-carousel">
                                <div class="ending-area-owl owl-carousel <?php if( $area_product_carosuel ) { ?> product<?php } ?>">
                        ...
                        <?php // TAXONOMY CAROUSEL (CATEGORIES, TAGS) 
                            ...
                            <div class="area-carousel">
                                <div class="ending-area-owl owl-carousel">
                                ...
                                <script>
                                    ( function($) { 'use strict';
                                        ...
                                        $(document).ready(function($) {
                                            ...
                                            if ( $('.ending-area-owl.owl-carousel').length ) { 

                                                $(".ending-area-owl.owl-carousel").owlCarousel({
