...
add_action( 'widgets_init', create_function( '', 'register_widget( "hannah_cd_posts_carousel_widget" );' ) );

class hannah_Cd_Posts_Carousel_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'hannah_cd_posts_carousel_widget',
			'&#10026; ' . esc_html__( 'Post Carousel', 'hannah-cd' ),
			array( 'description' => esc_html__( 'Show posts as a carousel.', 'hannah-cd' ) )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		// acf widget name
		$widget_id = 'hannah_cd_posts_carousel_widget';
		...
		if ( $my_posts_query->have_posts() ) :
			...
			<div class="posts-carousel-widget owl-carousel">
				...
				?>
					...
					<div class="posts-carousel-item" <?php if( has_post_thumbnail() ) { ?>style="background-image: url(<?php echo esc_url( $bgimage ); ?>)"<?php } ?>>
					
						<a class="posts-carousel-title" href="<?php the_permalink(); ?>">
				            <?php the_title(); ?>
				        </a>
                        ...
                        <a class="read-more on-bg" title="<?php the_title(); ?>" href="<?php the_permalink(); ?>">
                            <?php esc_html_e( 'Read more', 'hannah-cd' ); ?>
                        </a>
