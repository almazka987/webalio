...
if ( ! defined( 'FUSION_BUILDER_VERSION' ) ) {
	define( 'FUSION_BUILDER_VERSION', '1.1.2' );
}
// Plugin Folder Path.
...
include_once wp_normalize_path( FUSION_BUILDER_PLUGIN_DIR . '/inc/lib/fusion-library.php' );
...
if ( ! class_exists( 'FusionBuilder' ) ) :
	...
	class FusionBuilder {
		...
		public function admin_styles() {
			...
			$font_url = untrailingslashit( FUSION_BUILDER_PLUGIN_URL ) . '/assets/fonts/fonts';
