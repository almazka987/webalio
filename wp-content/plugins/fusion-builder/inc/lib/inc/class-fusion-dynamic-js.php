...
final class Fusion_Dynamic_JS {
	...
	public static function register_script( $handle = '', $src = '', $deps = array(), $ver = false, $in_footer = false ) {
		self::add_script( 'register', $handle, $src, $deps, $ver, $in_footer );
	}
	...
	public static function enqueue_script( $handle = '', $src = '', $deps = array(), $ver = false, $in_footer = false ) {
		self::add_script( 'enqueue', $handle, $src, $deps, $ver, $in_footer );
	}
	 ...
	 * @param bool        $in_footer Whether the script should be in the footer or not.
	 */
	private static function add_script( $action = 'enqueue', $handle = '', $src = '', $deps = array(), $ver = false, $in_footer = false ) {
