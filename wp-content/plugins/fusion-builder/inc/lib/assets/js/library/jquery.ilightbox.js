		...
		normalizeItems: function() {
			...
			$.each(iL.items, function(key, val) {
				...
				if (!options.width || !options.height) {
					...
					if (type == "video") { options.width = fusionLightboxVars.lightbox_video_width, options.height = fusionLightboxVars.lightbox_video_height; }
					else if (type == "iframe") { options.width = fusionLightboxVars.lightbox_video_width, options.height = fusionLightboxVars.lightbox_video_height; }
					else if (type == "flash") { options.width = fusionLightboxVars.lightbox_video_width, options.height = fusionLightboxVars.lightbox_video_height; }
				}
