	...
	if ( ! class_exists( 'FusionSC_Tabs' ) ) {
		...
		class FusionSC_Tabs extends Fusion_Element {
			...
			public function add_styling() {
				...
				$css[ $content_min_media_query ]['.fusion-tabs.vertical-tabs .nav-tabs > li .tab-link']['padding'] = '8px 10px';
				...
				$css[ $content_min_media_query ]['.fusion-tabs.vertical-tabs .nav']['width'] = '15.5%';
				...
				$css[ $content_min_media_query ]['.fusion-tabs.vertical-tabs.clean .nav-tabs li .tab-link']['padding'] = '10px 15px';
				$css[ $content_min_media_query ]['.fusion-tabs.vertical-tabs.clean .nav-tabs li .tab-link']['border'] = '1px solid';
				$css[ $content_min_media_query ]['.fusion-tabs.vertical-tabs.clean .nav']['width'] = '25%';
			...
			public function add_scripts() {
				...
				Fusion_Dynamic_JS::enqueue_script(
					'fusion-tabs',
					FUSION_BUILDER_PLUGIN_DIR . '/assets/js/min/general/fusion-tabs.js',
