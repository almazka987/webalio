	...
	class FusionSC_Column extends Fusion_Element {
		...
		public function add_scripts() {
			...
			Fusion_Dynamic_JS::register_script(
				'fusion-column-bg-image',
				FUSION_BUILDER_PLUGIN_DIR . '/assets/js/min/general/fusion-column-bg-image.js',
				array( 'jquery' ),
				'1',
				true
			);
			Fusion_Dynamic_JS::enqueue_script(
				'fusion-column',
				FUSION_BUILDER_PLUGIN_DIR . '/assets/js/min/general/fusion-column.js',
